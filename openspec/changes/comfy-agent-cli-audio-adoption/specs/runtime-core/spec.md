...
- **GIVEN** a bundle JSON whose first step is `{"step_id": "audio_t2a", "type": "generate", "name": "...", "capability_ref": "audio.t2a", "provider_policy": {"capability_required": "audio.t2a", "models_ref": "audio_local"}, "depends_on": [], "config": {"spec": {"comfy_workflow": "...", "comfy_params": {...}, "comfy_lifecycle": "none"}, "policy": {"max_attempts": 2, "timeout_seconds": 300}, "num_candidates": 1, "seed": 42}}`
