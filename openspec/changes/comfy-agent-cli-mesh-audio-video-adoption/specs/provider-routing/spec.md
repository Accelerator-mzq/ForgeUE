...
(Round 5 D10 修订 — Phase B Task 1.3 implementation discovery 后 user 授权方案 A:本 Requirement 取代 round 1-4「in-tree input file + absolute path injection」契约,改为「ComfyUI input/ + filename injection」对齐 LoadImage 节点实际语义。)
