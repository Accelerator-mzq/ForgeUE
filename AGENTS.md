...
- `docs/testing/test_spec.md` — 系统测试用例规格(541 用例索引 + fence 清单)
...
- 当前 P0–P4 + L1–L4 + F1–F5 + Plan C 全绿(541 用例;基线 491 + Codex audit fence 29 + src-layout / router-obs 根因定位 fence 6 + TBD-006 视觉 review 图像压缩 fence 10 + TBD-007 mesh 重试塌缩 fence 5);验收状态见 acceptance_report §3-§5
