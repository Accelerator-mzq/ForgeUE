...
Mirrors `framework/engine_bridge/unreal/contract/evidence.py` but imports
nothing from the framework package — UE Python runs in its own environment
without the framework installed. Reads/writes the same evidence.json file
that the export step seeded on disk.
"""
