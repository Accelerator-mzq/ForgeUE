...
Focus: 聚焦 change repo-put-streaming-payload 实施结果的三维 verify (Completeness / Correctness / Coherence);评估 tests 与 spec 是否一致、是否真的覆盖;不要 surface working tree 中未合并代码的问题。
Target: repo-put-streaming-payload-verify
</task>
