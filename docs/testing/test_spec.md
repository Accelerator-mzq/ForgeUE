...
| `test_failure_mode_map.py` | `runtime/failure_mode_map.py` | FR-RUNTIME-007, FR-WORKER-011, NFR-REL-001 | L1,L2 | 11 类 FailureMode 分类(audio_worker_timeout / audio_worker_unsupported 自 v1.7)、unsupported / mesh / audio 子类 isinstance 优先级 |
