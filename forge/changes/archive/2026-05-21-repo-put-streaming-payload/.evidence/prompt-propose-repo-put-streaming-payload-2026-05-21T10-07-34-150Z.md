...
Focus: 聚焦 change repo-put-streaming-payload 的 4 件套 (proposal.md / design.md / specs/ / tasks.md) 的设计决策、边界、可行性;不要 surface working tree 中未合并代码 (如 TBD-010 / executor lifecycle 等历史 finding) 的问题。
Target: repo-put-streaming-payload-propose
</task>
